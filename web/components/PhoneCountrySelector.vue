<template>
  <el-select v-loading="loading" v-model="current" class="phone_country_selector" filterable :filter-method="filterHander">
    <el-option v-for="country in resultCountries" :value="country.phone_code" v-bind:key="country.id">
  ...
  export default {
    ...
    methods: {
      initCountry(list){
        ...
        this.current = ct&&ct.phone_code; // 初始化当前国家
